...
import (
	...
	"github.com/smartcontractkit/plugin-testing-framework/blockchain"
...
type Accounts struct {
	...
	Store *solana.Wallet
	// OCRVault OCR program account to hold PLI
	...
	Owner *solana.Wallet
	// Mint PLI mint state account
	Mint *solana.Wallet
	// OCR2 Proposal account
	Proposal *solana.Wallet
	// MintAuthority PLI mint authority
...
func (c *Client) EstimateCostForPluginOperations(amountOfOperations int) (*big.Float, error) {
	panic("implement me")
}
