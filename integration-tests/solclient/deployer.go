...
import (
	...
	access_controller2 "github.com/goplugin/plugin-solana/contracts/generated/access_controller"
	ocr_2 "github.com/goplugin/plugin-solana/contracts/generated/ocr2"
	store2 "github.com/goplugin/plugin-solana/contracts/generated/store"
...
func (c *ContractDeployer) DeployLinkTokenContract() (*LinkToken, error) {
	...
	err = c.Client.TXAsync(
		"Creating PLI Token and associated accounts",
		instr,
		func(key solana.PublicKey) *solana.PrivateKey {
