...
require (
	...
	github.com/goplugin/plugin-solana v0.0.1//for plugin update changes
	github.com/goplugin/plugin-testing-framework/lib v0.3.1 //for plugin update changes
	github.com/goplugin/plugin-testing-framework/seth v0.1.1 //for plugin update changes
	github.com/goplugin/pluginv3.0/integration-tests v2.2.0 //for plugin update changes
	github.com/goplugin/pluginv3.0/v2 v2.2.0 //for plugin update changes
...
require (
	...
	github.com/goplugin/chain-selectors v0.1.1 //full plugin update changes
	//github.com/goplugin/chain-selectors v1.0.23 // indirect
	github.com/goplugin/plugin-automation v0.0.1 //full plugin update changes
	//github.com/goplugin/plugin-automation v1.0.5-0.20241009152924-78acf196c332 // indirect
	github.com/goplugin/plugin-ccip v0.0.1//full plugin update changes
	...
	//github.com/goplugin/plugin-cosmos v0.4.1-0.20241008135525-d75be72f25bb // indirect
	github.com/goplugin/plugin-data-streams v0.1.1 // for plugin update changes
	//github.com/goplugin/plugin-data-streams v0.1.0 // indirect
	github.com/goplugin/plugin-feeds v0.1.1 // indirect
	//github.com/goplugin/plugin-feeds v0.1.1 // indirect
	github.com/goplugin/plugin-starknet/relayer v0.0.3//for plugin update changes
	//github.com/goplugin/plugin-starknet/relayer v0.0.1-beta-test.0.20241009122052-5e3515805bca // indirect
	github.com/goplugin/plugin-testing-framework/lib/grafana v0.1.1 //for plugin update changes
	//github.com/goplugin/plugin-testing-framework/lib/grafana v1.50.0 // indirect
	github.com/goplugin/plugin-testing-framework/wasp v0.1.1 //for plugin update changes
	//github.com/goplugin/plugin-testing-framework/wasp v1.50.0 // indirect
	github.com/goplugin/grpc-proxy v0.1.1 //for plugin update changes
	//github.com/goplugin/grpc-proxy v0.0.0-20240830132753-a7e17fec5ab7 // indirect
	github.com/goplugin/tdh2/go/ocr2/decryptionplugin v0.3.1 //for plugin update changes
	//github.com/goplugin/tdh2/go/ocr2/decryptionplugin v0.0.0-20241009055228-33d0c0bf38de // indirect
	github.com/goplugin/tdh2/go/tdh2 v0.3.1 //for plugin update changes
	//github.com/goplugin/tdh2/go/tdh2 v0.0.0-20241009055228-33d0c0bf38de // indirect
	github.com/goplugin/wsrpc v0.1.1 //for plugin update changes
