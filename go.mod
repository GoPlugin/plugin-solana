module github.com/goplugin/plugin-solana
...
require (
	...
	github.com/goplugin/plugin-common v0.0.1-beta
	...
	//github.com/goplugin/plugin-libocr v0.0.0-20240702141926-063ceef8c42e
