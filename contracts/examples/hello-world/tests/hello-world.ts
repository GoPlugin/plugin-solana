...
const PLUGIN_PROGRAM_ID = "HEvSKofvBgfaexv23kMabbYqxasxU3mQ4ibBMEmJWHny";
...
describe("hello-world", () => {
  ...
  it("Is initialized!", async () => {
    ...
    const storeProgram = new Program(storeIdl, PLUGIN_PROGRAM_ID, provider);
    ...
    tx = await program.methods
      .execute()
      .accounts({
        pluginFeed: feed.publicKey,
        pluginProgram: PLUGIN_PROGRAM_ID,
      })
      .rpc({ commitment: "confirmed" });
