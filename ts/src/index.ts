...
export const PLUGIN_AGGREGATOR_PROGRAM_ID = new PublicKey(
  "cjg3oHmg9uuPsP8D6g29NWvhySJkdYdAo9D25PRbKXJ"
);
export const PLUGIN_STORE_PROGRAM_ID = new PublicKey(
...
export class OCR2Feed {
  ...
  static async load(
    programID: PublicKey = PLUGIN_AGGREGATOR_PROGRAM_ID,
